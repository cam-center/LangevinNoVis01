...
@CommandLine.Command(name = "clusters", description = "Compute cluster stats over multiple trials.", mixinStandardHelpOptions = true, versionProvider = Version.class, subcommands = {})
